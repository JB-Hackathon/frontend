...
import type { EditorContent, SourceCard } from '@/types/api';

// ─── 더미 데이터 ─────────────────────────────────────────────────────────────


const DUMMY_SOURCE_CARDS: SourceCard[] = [
  {
    label: 'CARD 1 · 헤드라인',
    lines: ['매월 30만원만 넣어도,', '연 최대 7.0% 우대금리.'],
  },
  {
    label: 'CARD 2 · 본문',
    lines: ['지금 가입하면 누구나 받을 수 있는 혜택,', '놓치면 손해입니다.'],
  },
  {
    label: 'CARD 3 · CTA',
...
const DUMMY_EDITOR_CONTENT: EditorContent = {
  ...
  sourceCards: DUMMY_SOURCE_CARDS,
  creatorNote:
